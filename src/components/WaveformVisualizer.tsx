...
export const WaveformVisualizer: React.FC<WaveformVisualizerProps> = ({
  ...
  return (
    <>
      ...
      {/* Processing Popup - Show for both waveform processing and audio loading */}
            ...
            <div className="text-center">
              <div className="mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  {isProcessing ? 'Processing Audio' : 'Loading Audio'}
                </h3>
                <p className="text-sm text-gray-600 mb-4">
                  {isProcessing ? 'Generating waveform for playback...' : 'Preparing audio player...'}
                </p>
              </div>
              
              {/* Progress Bar - only show for waveform processing */}
              {isProcessing && (
                <>
              ...
              {/* Indeterminate loading for audio loading */}
              {isAudioLoading && !isProcessing && (
                <div className="w-full bg-gray-200 rounded-full h-2 mb-2">
